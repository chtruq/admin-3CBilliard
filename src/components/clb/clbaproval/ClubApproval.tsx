...
import CLubApprovalTable from "./CLubApprovalTable";

function ClubApprovalPagination({ data }: { data: any }) {
  ...
  return (
    <>
      <CLubApprovalTable data={data} loading={loading} />
...
export default ClubApprovalPagination;
