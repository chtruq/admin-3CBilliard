        ...
        <section>
          <div className='grid md:grid-cols-2 pt-4 md:pt-10'>
            <div className='px-5 md:pl-12'>
              ...
              <p className='text-[#040F13] font-light text-2xl mt-6 mb-2 md:pb-4'>Tìm kiếm và đặt bàn đơn giản tại câu lạc bộ bida và tham gia cộng đồng bida trong khu vực của bạn!!
              </p>
